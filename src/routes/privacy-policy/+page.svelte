<div class="container">
	<article class="article-main">
		...
		<ul>
			...
			<li>
				Usage Data, such as IP address, browser type, pages visited, and time spent on those pages
			</li>
		</ul>
